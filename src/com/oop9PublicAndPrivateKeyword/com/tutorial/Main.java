package com.oop9PublicAndPrivateKeyword.com.tutorial;

class Player {
  String name; // default, dia akan bisa dibaca dan ditulis dari luar class dan di dalam satu
               // file dan package, atau di file berbeda tapi masih package yg sama
  public int exp; // public, dia akan bisa dibaca dan ditulis dari luar class dan package yg
                  // berbeda. kalau di file yg sama dengan main akan error
